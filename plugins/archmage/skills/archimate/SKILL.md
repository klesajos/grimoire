...
| `reference/ea-bridge.md` | How Enterprise Architect represents ArchiMate (the ArchiMate 3 MDG, UML elements carrying ArchiMate stereotypes), the element/relationship → EA-stereotype mapping (**marked "verify in live EA"**), and the EA MCP gotchas. Points to `ea-modeling`. | The user wants to build the ArchiMate model in EA, or asks how ArchiMate maps to EA types/stereotypes. |
