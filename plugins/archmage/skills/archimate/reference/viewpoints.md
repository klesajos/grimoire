...
- For **real** ArchiMate notation, build in a proper tool: **Archi** (free, open source, the reference editor), **Enterprise Architect** (see `ea-bridge.md`), Visual Paradigm, or BiZZdesign. These render correct icons, colors, and line styles and enforce the relationship table.
